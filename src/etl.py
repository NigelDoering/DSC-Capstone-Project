...
def get_data(logger, preprocessed_data_path: str, output_data_path: str, dims: list, labels: dict,
    output_user_data_path: str,
    exclude_replies: bool, include_rts: bool, max_recent_tweets: int, tweet_ids: list,
    ...
    output_user_data_path, exclude_replies, include_rts, max_recent_tweets, tweet_ids=tweet_ids)
